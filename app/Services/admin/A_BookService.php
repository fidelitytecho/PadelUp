...
class A_BookService
{
    ...
    private $booking, $service, $player;
     ...
     */
    public function __construct(BookingInterface $booking, PlayerInterface $player, ServiceInterface $service)
    {
    ...
    public function book(array $data): JsonResponse
    {
        ...
        if ($this->isBookingOverlap($data)) {
            ...
            return response()->json([
                ...
                'data'=> new A_BookingResource($createdBooking->load('Customer.User', 'Currency', 'Court', 'Player')),
            ]);
        }
        $output = ([
            'success' => false,
